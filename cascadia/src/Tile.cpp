...
Tile::Tile(Biome biome_1, Biome biome_2,
           std::vector<WildlifeType> wildlife_token_options)
    : m_biome_1(biome_1), m_biome_2(biome_2),
      m_wildlife_token_options(wildlife_token_options),
      m_wildlife_token(WildlifeType::NoToken) {}

Tile::Tile(Biome biome_1, Biome biome_2,
           WildlifeType single_wildlife_token_option)
    : m_biome_1(biome_1), m_biome_2(biome_2),
      m_wildlife_token(WildlifeType::NoToken) {
