...
void Board::initializeBoard()
{
    ...
    m_tiles.emplace(HexCoordinate{0,0}, Tile(BiomeUtilities::getRandomBiome(), BiomeUtilities::getRandomBiome(), WildlifeTypeUtilities::getRandomWildlifeTypeVector(3)));
    m_tiles.emplace(HexCoordinate{0,1}, Tile(BiomeUtilities::getRandomBiome(), BiomeUtilities::getRandomBiome(), WildlifeTypeUtilities::getRandomWildlifeTypeVector(3)));
    m_tiles.emplace(HexCoordinate{-1,1}, Tile(BiomeUtilities::getRandomBiome(), BiomeUtilities::getRandomBiome(), WildlifeTypeUtilities::getRandomWildlifeTypeVector(3)));
}
